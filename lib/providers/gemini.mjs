 ...
 * bucket empties the chain tries the next. Defaults are the three models verified
 * CALLABLE on this account (listed ≠ callable — probed 4 Aug); override with
...
export const MODEL_CHAIN = (process.env.GEMINI_MODEL_CHAIN
  ...
  : [DEFAULT_MODEL, 'gemini-3.5-flash', 'gemini-flash-latest']
